    ...
    <main className="mx-auto max-w-5xl px-6 md:px-10 py-12 md:py-14">
      ...
      <header className="space-y-3">
        ...
        <p className="max-w-2xl text-base md:text-lg text-muted-foreground leading-relaxed">
          MyStudyPlanner is a calm, simple study planner built around how school actually works — so you focus
          on doing the work, not managing tools.
        </p>
      </header>
        ...
        <div className="lg:col-span-7 space-y-6">
          <div className="rounded-2xl border border-border bg-card shadow-sm p-6 md:p-7">
            ...
            <p className="mt-2 text-sm md:text-base text-muted-foreground leading-relaxed">
              Subjects, assessments, deadlines, and study sessions pile up fast. Most planners either feel too
              empty to be useful, or so complicated that they become another thing to manage.
            </p>
            <p className="mt-3 text-sm md:text-base text-muted-foreground leading-relaxed">
              MyStudyPlanner was built by students who wanted one place that feels clean and obvious:
              what’s due, what’s next, and how consistent you’ve been — without noise.
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-border bg-card shadow-sm p-6 md:p-7">
            ...
            <ul className="mt-3 space-y-3 text-sm md:text-base text-muted-foreground">
              <li className="flex gap-3">
                ...
                <span>
                  <span className="text-foreground font-medium">Real school structure:</span> subjects,
                  assessments, and study sessions live together.
                </span>
              </li>
              <li className="flex gap-3">
                <span className="mt-1 h-2.5 w-2.5 rounded-full bg-primary/70 shrink-0" />
                <span>
                  <span className="text-foreground font-medium">Calm by default:</span> minimal UI, no
                  gamification, no loud dashboards.
                </span>
              </li>
              <li className="flex gap-3">
                <span className="mt-1 h-2.5 w-2.5 rounded-full bg-primary/70 shrink-0" />
                <span>
                  <span className="text-foreground font-medium">Consistency wins:</span> logging study is
                  fast and flexible so it’s easy to keep going.
                </span>
              </li>
              <li className="flex gap-3">
                <span className="mt-1 h-2.5 w-2.5 rounded-full bg-primary/70 shrink-0" />
                <span>
                  <span className="text-foreground font-medium">Useful insights:</span> see study time and
                  results so you can adjust early.
                </span>
              </li>
            </ul>
          </div>
          ...
          <div className="rounded-2xl border border-border bg-card shadow-sm p-6 md:p-7">
            ...
            <p className="mt-2 text-sm md:text-base text-muted-foreground leading-relaxed">
              MyStudyPlanner is built with privacy in mind. You can explore with example data, and nothing is
              sold or shared. The app only stores what it needs to work — nothing more.
            </p>
          </div>
        </div>
