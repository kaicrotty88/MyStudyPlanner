...
const benefits = [
  {
    ...
    description: "Keep work from different units visible in one place instead of splitting it across apps.",
  },
  {
    title: "See deadlines clearly",
    description: "Stay aware of what is due next so you can prioritise earlier.",
  },
  {
    title: "Plan work over time",
    description: "Use study sessions to break assignments into manageable pieces.",
  },
  {
    title: "Stay calmer during semester",
    description: "A clearer assignment plan makes heavy university workloads feel easier to manage.",
  },
];
    ...
    <main className="mx-auto max-w-5xl px-6 py-12 md:px-10 md:py-16">
      <header className="max-w-3xl space-y-4">
        ...
        <p className="text-base leading-relaxed text-muted-foreground md:text-lg">
          MyStudyPlanner helps university students organise assignments, deadlines, and study sessions in one place so
          semester workloads are easier to manage.
        </p>
      ...
      <section className="mt-10 rounded-3xl border border-border bg-card p-6 shadow-sm md:p-8">
        ...
        <div className="mt-4 space-y-3 text-sm leading-relaxed text-muted-foreground md:text-base">
          <p>
            University assignments often pile up because they arrive across multiple units with different due dates and
            different workload sizes.
          </p>
          <p>
            A dedicated assignment planner helps you keep them visible, space them out, and stay clearer on what
            matters next.
          </p>
        </div>
      ...
      <section className="mt-6 rounded-3xl border border-border bg-card p-6 shadow-sm md:p-8">
        <h2 className="text-lg font-semibold text-foreground">How MyStudyPlanner fits university work</h2>
        <div className="mt-4 space-y-3 text-sm leading-relaxed text-muted-foreground md:text-base">
          <p>
            Add your units, enter assignments, and keep deadlines close to your study sessions and exam prep.
          </p>
          <p>
            That makes it easier to plan realistically instead of reacting to deadlines at the last minute.
          </p>
        </div>
      </section>
